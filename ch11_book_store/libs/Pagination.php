    ...
    public function showPagination($link){
        ...
        if($this->totalPage > 1){
            ...
            if($this->currentPage > 1){
                $start 	= '<div class="button2-right"><div class="start"><a onclick="javascript:changePage(1)" href="javascript:void(0)">Start</a></div></div>';
                $prev 	= '<div class="button2-right"><div class="prev"><a onclick="javascript:changePage('.($this->currentPage-1).')" href="javascript:void(0)">Previous</a></div></div>';
            }
            ...
            if($this->currentPage < $this->totalPage){
                $next 	= '<div class="button2-left"><div class="next"><a onclick="javascript:changePage('.($this->currentPage+1).')" href="javascript:void(0)">Next</a></div></div>';
                $end 	= '<div class="button2-left"><div class="end"><a href="javascript:void(0)" onclick="javascript:changePage('.$this->totalPage.')">End</a></div></div>';
            }
