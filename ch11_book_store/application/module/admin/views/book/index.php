...
// COLUMN
$columnPost     = isset($this->arrParam['filter-column']) ? $this->arrParam['filter-column'] : '';
$orderPost      = isset($this->arrParam['filter-column-dir']) ? $this->arrParam['filter-column-dir'] : '';
$keyword        = isset($this->arrParam['filter_search']) ? $this->arrParam['filter_search'] : '';
$filterState    = isset($this->arrParam['filter_state']) ? $this->arrParam['filter_state'] : 'default';
$filterSpacial  = isset($this->arrParam['filter_special']) ? $this->arrParam['filter_special'] : 'default';
$filterCategory = isset($this->arrParam['filter_category_id']) ? $this->arrParam['filter_category_id'] : 'default';
...
$lblPrice 		= Helper::cmsTitleSost('Price', 'price', $columnPost, $orderPost);
$lblSaleOff		= Helper::cmsTitleSost('Sale Off', 'sale_off', $columnPost, $orderPost);
$lblCategory	= Helper::cmsTitleSost('Category', 'category_id', $columnPost, $orderPost);
$lblStatus		= Helper::cmsTitleSost('Status', 'status', $columnPost, $orderPost);
$lblSpecial		= Helper::cmsTitleSost('Special', 'special', $columnPost, $orderPost);
...
$selectboxSpecial	= Helper::cmsSelectbox('filter_special', 'inputbox', $arrSpecial, $filterSpacial);

// CATEGORY
$selectboxCategory	= Helper::cmsSelectbox('filter_category_id', 'inputbox', $this->selectbox, $filterCategory);
...
<div id="element-box">
    <div class="m">
        <form action="#" method="post" name="adminForm" id="adminForm">
            ...
            <div>
                <input type="hidden" name="filter-column" value="name">
                <input type="hidden" name="filter-page" value="1">
                <input type="hidden" name="filter-column-dir" value="asc">
            </div>
        </form>
