...
$dataForm     = array_merge($arrayElement, isset($this->arrParam['form']) ? $this->arrParam['form'] : $arrayElement);
...
if (isset($this->arrParam['form']['id'])) {
    ...
    $picture            = '<p><img src="' . UPLOAD_URL . 'category' . DS . '60x90-' . $dataForm['picture'] . '"></p>';
            ...
            <div class="width-100 fltlft">
                <fieldset class="adminform">
                    ...
                    <ul class="adminformlist">
                        <?php echo $rowName . $rowStatus . $rowPicture . $rowOrdering . $rowID; ?>
                    </ul>
                    <div class="clr"></div>
                    <div>
                        <?php echo $inputToken; ?>
